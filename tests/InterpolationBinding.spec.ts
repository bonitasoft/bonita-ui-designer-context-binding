...
describe('interpolation binding object', () => {
    ...
    beforeEach(() => {
        ...
        let context = new Map();
        context.set('anInterpolationToResolve', new VariableAccessor({},'anInterpolationToResolve','My Default Label'));
        context.set('anotherVariable', new VariableAccessor({},'anotherVariable','Another label'));
    ...
    it('should interpolate value when value contains only one {{variable}} syntax', () => {
        ...
        let context = new Map();
        context.set('anInterpolationToResolve', new VariableAccessor({},'anInterpolationToResolve','is custom by interpolation'));
        context.set('anotherVariable', new VariableAccessor({},'anotherVariable','Another label'));
    ...
    it('should interpolate value when value contains more than one {{variable}} syntax', () => {
        ...
        let context = new Map();
        context.set('anInterpolationToResolve', new VariableAccessor({},'anInterpolationToResolve','is custom by interpolation'));
        context.set('anLabel', new VariableAccessor({},'anLabel','Another label'));
    ...
    it('should return empty when variable in expression is not set in context', () => {
        ...
        let context = new Map();
        context.set('anLabel', new VariableAccessor({},'anLabel', 'My default'));
    ...
    it('should return "0" when variable value is equals to 0', () => {
        ...
        let context = new Map();
        context.set('$index', new VariableAccessor({},'$index',0));
    ...
    it('should interpolate value when value is a json variable', () => {
        ...
        let context = new Map();
        context.set('myJsonVariable', new VariableAccessor({},'myJsonVariable', JSON.parse('[{"name":"Robert"},{"name":"Walter"}]')));
